...
"}")
        ...
        self.horizontalSpacer_3 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
...
"}")
        ...
        self.gridLayout_2.addWidget(self.lineEditData, 2, 1, 1, 1, QtCore.Qt.AlignLeft)

        self.horizontalSpacer_2 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
...
"}")
        icon = QtGui.QIcon()
        icon.addFile(u"app/resources/img/icons/24x24/cil-arrow-circle-right.png", QtCore.QSize(), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButtonConfirm.setIcon(icon)
        self.pushButtonConfirm.setIconSize(QtCore.QSize(24, 24))

        self.gridLayout_2.addWidget(self.pushButtonConfirm, 2, 2, 1, 1, QtCore.Qt.AlignRight)
...
"}")
    ...
    def retranslateUi(self):
        self.setWindowTitle(QtCore.QCoreApplication.translate("MainWindow", u"MainWindow", None))
        self.pushButtonConfirm.setText(QtCore.QCoreApplication.translate("MainWindow", u"Confirmar", None))
