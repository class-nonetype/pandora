...
class EnvironmentModel(object):
    ...
    def create_scripts_directory(self):
        ...
        if self.attr['system']['os'] == 'Windows':
            script_file_path = self.attr['path']['storage']['scripts'] + '\\' + 'CREATE_TABLE_PLAYLIST.sql'
            
        elif self.attr['system']['os'] == 'Windows':
            script_file_path = self.attr['path']['storage']['scripts'] + '/' + 'CREATE_TABLE_PLAYLIST.sql'
        ...
        '''
        if self.attr['system']['os'] == 'Windows':
            script_file_path = self.attr['path']['storage']['scripts'] + '\\' + 'CREATE_TABLE_INTEREST.sql'
    ...
    def create_local_database(self):
        ...
        try:
            if self.attr['system']['os'] == 'Windows':
                database_file_path = self.attr['path']['storage']['database'] + '\\' + 'storage.db'
